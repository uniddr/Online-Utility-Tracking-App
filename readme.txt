...
branch of our project GitHub repository in a zipped file named "DDL and Dummy Data.zip". The db_table_structure.txt file contains the DDL statements along with
a one line description for some of the table attributes that might seem confusing from the name. The rest of the files named testData_'table_name'.txt
contain the SQL statements to insert dummy data into the respective tables.
